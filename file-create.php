...
<head>
    ...
    <title>File create - Dashboard</title>
        ...
        <form class="card col-sm-4 mx-auto shadow border-0 rounded-4" enctype="multipart/form-data" method="POST">
            ...
            <div class="card-body">
                ...
                <div class="form-group mb-3">
                    ...
                    <textarea class="form-control form-control-lg shadow-none border font-14" name="description" rows="5"></textarea>
                </div>
                <div class="form-group mb-3">
                    <label class="fw-bold mb-0 font-14" for="file">File</label>
                    <input class="form-control form-control-lg shadow-none border font-14" name="file" type="file" required />
                </div>
                <div class="form-group mb-3 col-sm-12">
