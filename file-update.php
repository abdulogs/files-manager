...
<head>
    ...
    <title>File update - Dashboard</title>
        ...
        <form class="card col-sm-4 mx-auto shadow border-0 rounded-4" enctype="multipart/form-data" method="POST">
            ...
            <div class="card-body">
                <div class="form-group mb-3 col-sm-12">
                    <label class="fw-bold mb-0 font-14" for="folder_id">Folder</label>
                    <select name="folder_id" class="form-select shadow-none border form-control-lg font-14" required>
                        <option value="">Select</option>
                        <?php $folders = module::folders(); ?>
                        <?php foreach ($folders as $folder) : ?>
                            <?php $selected = ($folder['id'] == $data["folder_id"]) ? "selected" : ""; ?>
                            <option value="<?php echo $folder['id'] ?>" <?php echo $selected; ?>>
                ...
                <div class="form-group mb-3">
                    ...
                    <textarea class="form-control form-control-lg shadow-none border font-14" name="description" rows="5"><?php echo $data["description"]; ?></textarea>
                </div>
                <div class="form-group mb-3">
                    <label class="fw-bold mb-0 font-14" for="file">File</label>
                    <input class="form-control form-control-lg shadow-none border font-14" name="file" type="file" />
                    <input type="hidden" name="old_file" value="<?php echo $data["file"]; ?>">
                    <a href="uploads/<?php echo $data["file"]; ?>" class="text-dark" target="_blank"><?php echo $data["file"]; ?></a>
                </div>
            ...
            <div class="card-footer border-top bg-transparent text-center">
                <a href="files.php" class="btn btn-light font-14 ps-5 pe-5 border rounded-5"><b>Go back</b></a>
