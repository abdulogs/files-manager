    ...
    <main class="container container-sm container-md container-lg container-xl container-xxl">
        ...
        <section class="bg-white card shadow rounded-4 border-0 mb-5">
            <div class="card-header bg-transparent d-flex align-items-center border-0">
                ...
                <a href="folder-create.php" class="d-flex align-items-center btn btn-light border ms-auto rounded-5">
                            ...
                            <?php foreach ($listing as $item) : ?>
                                <tr>
                                    <td class="align-middle px-4" data-label="Name">
                                        <a href="folder-details.php?id=<?php echo $item["id"]; ?>" class="fw-bold link-dark font-14 text-decoration-none">
                                            <?php echo $item["name"]; ?>
                                        </a>
                                        <div class="d-flex align-items-center m-0 mt-2">
                                            <a href="folder-update.php?id=<?php echo $item["id"]; ?>" class="text-decoration-none text-success me-1">Edit</a>
                                            <b>-</b>
                                            <a href="folders.php?id=<?php echo $item["id"]; ?>&action=delete" class="text-decoration-none text-danger mx-1">Delete</a>
                                            <b>-</b>
